...
\begin{enumerate}
\item An ÒallÓ rule that compiles the program using gcc and generates an executable 
named ÒhelloÓ
\item A ÒrunÓ rule that runs the program and redirects its output to the file Òout.txtÓ
\item A ÒcleanÓ rule that deletes the executable and the output file created by the 
previous rules.
